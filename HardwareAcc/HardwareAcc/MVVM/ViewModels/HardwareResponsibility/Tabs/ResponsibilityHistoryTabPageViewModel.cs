...
public class ResponsibilityHistoryTabPageViewModel : BaseFormViewModel<HardwareModel>
{
     private readonly IHardwareResponsibilityHistoryRepository _repository;

    public ResponsibilityHistoryTabPageViewModel(IHardwareResponsibilityHistoryRepository repository)
    {
